...
If you have created your own language pack, or have an update of an existing one, you can send [gettext PO and MO files](http://codex.wordpress.org/Translating_WordPress) to [Us](http://vivacityinfotech.net/contact-us/) so that We can bundle it into this plugin. You can download the latest [POT file](http://plugins.svn.wordpress.org/wp-responsive-jquery-slider/tags/1.5/languages/wp-responsive-jquery-slider.pot), and [PO files](http://plugins.svn.wordpress.org/wp-responsive-jquery-slider/tags/1.5/languages/) in each language.
